...
Tags: portfolio, easy portfolio, responsive portfolio, gallery, free portfolio
...
Portfolio filter gallery for your blog.
A super easy way to create beautiful and responsive portfolio filter gallery for WordPress.

== Description ==

A super easy way to create beautiful and responsive portfolio filter gallery to your WordPress site. 
The plugin is fully responsive work with all devices like desktop, tablets, mobile. 
You can create portfolio gallery into your site in just a minute. 
You will get multiple column layouts, multiple hover style, play with multiple colors.

And you will get much more with pro version.
...
> * [Portfolio Filter Gallery Premium Theme One](http://demo.awplife.com/portfolio-filter-gallery-premium/ "Portfolio Filter Gallery Premium Theme One")
> * [Portfolio Filter Gallery Premium Theme One - Manage Thumbnail Spacing](http://demo.awplife.com/portfolio-filter-gallery-premium/manage-thumbnail-spacing/ "Portfolio Filter Gallery Premium Theme One - Manage Thumbnail Spacing")
> * [Portfolio Filter Gallery Premium Theme One - Multiple Column Layout](http://demo.awplife.com/portfolio-filter-gallery-premium/4-column-layout/ "Portfolio Filter Gallery Premium Theme One - Manage Thumbnail Spacing - Multiple Column Layout")

> * [Portfolio Filter Gallery Premium Theme Two](http://demo.awplife.com/portfolio-filter-gallery-premium/portfolio-filter-gallery-premium/ "Portfolio Filter Gallery Premium Theme Two")
...
* Filters - Easy way to create filters in portfolio
* Bootstrap Lightbox - The best bootstrap lightbox
* Multiple Column Layout - Show portfolio gallery in multiple column
* Responsive - All device compitable
* Numbering - show numbering on images 
* Title - Show tilte on image
* Spacing & without spacing - Show gallery with and without spacing 
* Gray Scale - Make beautful your gallery with garay scale effect
* Masonary - Masonary style gallery
* Multi Color For Filters - Multiple colors for filters
...
*  ** The portfolio filter gallery plugin is very easy to use it also user-friendly and well designed, you can easily create your portfolio into few minutes. The portfolio setting is created with dropdown toggle bar for separate the settings, the user can easily understand and easily configure the settings of the portfolio. The link option filters option and description option comes below the image. **
*  ** The portfolio filter gallery is fully responsive and works well with all devices like Desktop tablets iPhone etc **
*  ** You will get the best filtration in the portfolio in multiple themes. **
*  ** You can change unlimited colors in the portfolio, change title & description background color, change title description color, also change the border color of images. **
*  ** You can customize image border like border color, border size. **
...
After activating Portfolio Filter Gallery plugin, go to plugin menu.
...
* [Instagram Type Gallery](https://wordpress.org/plugins/insta-type-gallery/ "Best Instagram Type Gallery") - The Instagram Type Gallery Plugin to create awesome Layout. 
...
6. Add Filters For Portfolio Filter Gallery
7. Filteriz Thumbnails By Filters
...
* Enhancements: None
* Bug Fix: Yes, Added "all" button changeble.
* Additional changes: None
...
* Enhancements: Featured Plugin Page Added
* Bug Fix: None
* Additional changes: None
...
* Enhancements: None
* Bug Fix: Yes On loading
* Additional changes: Settings
